...
<table height="317" cellpadding="5" cellspacing="5">
    <tr>
    ...
    <tr>
    <td height="75"></td>
    <td><input type="submit" value="Oyunu Güncelle" /></td>
    </tr>
...
<?php 
        ...
        if($_POST){
            ...
            $guncelle        =    mysqli_query($baglan,"update bilgiler set cikis_tarihi='$yil',oyun_adi='$ad', turu='$tur', yapimci='$yapimci' where kayit_kodu='$seri'");
...
<div class="vertical-menu">
  <p><a href="ekle.php" class="active"><strong>Oyun Ekle</strong></a>
